...
Waku offers decentralised, open-source messaging protocols designed for global accessibility on even resource-restricted devices. It empowers users to reclaim control over their data and communication, counteracting the global reach of technology giants and their centralised messaging applications that we currently rely on. In this blog post, we will touch on Waku's achievements in H1 2023, which centred around overcoming scalability limitations, before sharing our core H2 2023 milestones constructed around our goal of launching Waku Network Gen 0.

<!-- TODO: summary needs to be shorter (truncate pushed earlier). -->
<!--truncate-->
...
* [Add support for multiple platforms](https://github.com/waku-org/pm/milestone/2)<span style="text-decoration:underline;">:</span>

We will be researching and experimenting with nim in 2023 to lay the groundwork for supporting multiple platforms.

* [Instate quality assurance processes](https://github.com/waku-org/pm/milestone/3)<span style="text-decoration:underline;">;</span>
