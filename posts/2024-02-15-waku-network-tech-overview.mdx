...
For any peer-to-peer system to be reliable and decentralized, there needs to be a mechanism to find new peers or nodes in said system, usually called _peer discovery_.

Waku uses discv5, similarly to Ethereum. Minor enhancements to ENR have been done to enable Waku node to advertise:
